...
INSERT INTO accounts (username, city, transactions_completed, transactions_attempted, account_balance) VALUES ('koua', 'saint paul', 6, 11, 0.00);
...
WHERE (city = 'phoenix' or city = 'chicago') and transactions_attempted < 5;